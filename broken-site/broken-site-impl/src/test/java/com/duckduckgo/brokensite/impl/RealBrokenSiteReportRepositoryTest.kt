...
class RealBrokenSiteReportRepositoryTest {
    ...
    fun before() {
        ...
        testee =
            RealBrokenSiteReportRepository(
    ...
    @Test
    fun whenGetLastSentDayCalledWithEmptyHostnameThenReturnNull() =
        runTest {
            val hostname = ""
    ...
    @Test
    fun whenGetLastSentDayCalledWithNewHostnameThenReturnNull() =
        runTest {
    ...
    @Test
    fun whenGetLastSentDayCalledWithExistingHostnameThenReturnLastSeenDay() =
        runTest {
            val hostname = "www.example.com"
            val hostnameHashPrefix = "80fc0f"
    ...
    @Test
    fun whenSetLastSentDayCalledWithNonEmptyHostnameThenUpsertBrokenSiteReportIsCalled() =
        runTest {
            val hostname = "www.example.com"
    ...
    @Test
    fun whenCleanupOldEntriesCalledThenCleanupBrokenSiteReportIsCalled() =
        runTest {
