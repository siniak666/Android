...
class WebViewBlobDownloaderModernImpl @Inject constructor(
    ...
    override suspend fun configureWebViewForBlobDownload(webView: WebView) {
    ...
    @SuppressLint("RequiresFeature")
    override suspend fun requestBlobToDataUri(url: String) {
    ...
    override suspend fun saveReplyProxyForBlobDownload(
        originUrl: String,
